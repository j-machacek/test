...
<img src="./gbo/triaxCD.png" alt="triaxCD" width="66%"/>

and oedometric compression tests:

<img src="./gbo/oedometer.png" alt="oedometer" width="33%"/>
...
<img src="./gbo/fitness_function.png" alt="fitness_function" width="66%"/>
...
<img src="./gbo/statistics.png" alt="statistics" width="66%"/>
...
<img src="./gbo/triaxCD_all.png" alt="triaxCD_all" width="66%"/>
...
ACTmealpy.optimize(maxiter=100, n_cpu=4, method='GradientBased')
```
